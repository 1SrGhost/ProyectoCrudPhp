		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand">Contactos</a>
				</div>
				...
				<div class="tab-pane active" id="tab_consultar">
					<div class="row form-horizontal">
						<div class="panel panel-default">
							<div class="panel-heading">Contactos Existentes</div>
...
?>
			...
			<div class="modal" id="nuevoUsu" tabindex="-1" role="dialog" aria-labellebdy="myModalLabel"
				aria-hidden="true">
							...
							<form action="insertar.php" method="GET">
								...
								<div class="form-group">
									...
									<input class="form-control" id="edad" name="edad" type="text"
										onkeypress="return numeros(event)" placeholder="Edad" required></input>
			...
			<div class="modal" id="editUsu" tabindex="-1" role="dialog" aria-labellebdy="myModalLabel"
				aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
						...
						<div class="modal-body">
							<form action="actualiza.php" method="POST">
								...
								<div class="form-group">
									<label for="edad">Edad:</label>
									<input class="form-control" id="edad" required name="edad"
										onkeypress="return numeros(event)" type="text"></input>
